...
def main():
    ...
    with open(filepath) as fp:
        for line in fp.readlines():
            ...
            ## Check whether the intersection is the same as any of the ranges  
            if sorted(list(range1)) == sorted(list(intersection)) or sorted(list(range2)) == sorted(list(intersection)):
                count_overlaps += 1
